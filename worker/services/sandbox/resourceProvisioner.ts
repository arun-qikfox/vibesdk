...
export class ResourceProvisioner {
    ...
    async createKVNamespace(projectName: string): Promise<ResourceProvisionResult> {
        try {
            ...
            const result: CloudflareKVNamespaceResponse = await response.json() as CloudflareKVNamespaceResponse;
    ...
    async createD1Database(projectName: string): Promise<ResourceProvisionResult> {
        try {
            ...
            const result: CloudflareD1DatabaseResponse = await response.json() as CloudflareD1DatabaseResponse;
